<x-docent-layout>
    ...
    @foreach ($appointments as $appointment)
        <div class="grid grid-cols-8">
            ...
            <div class="col-span-1 bg-blue-600 text-white rounded-r-lg border border-gray-200 hover:bg-blue-700 hover:border-4 hover:border-gray-350 hover:shadow-xl">

            ...
            <div class="bg-white border-gray-500 overflow-hidden">
                <form action="{{ route('planning/store') }}" method="post">
                    ...
                    <div class="p-4">
                        ...
                        <input id="title" class="block p-2 border rounded-md w-full" type="text" name="title" value="{{ old('title') }}"/>
                    </div>
                    <div class="p-4">
                        <label for="description">Beschrijving:</label>
                        <textarea id="description" class="block p-2 border rounded-md w-full" type='text' name='description' rows="6" value="{{ old('description') }}">{{ old('description') }}</textarea>
                    </div>
                    <div class="p-4">
